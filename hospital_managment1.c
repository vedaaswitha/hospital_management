   // Header Files or libraries used in the code
...
int dob;
    ...
    // Structure
    //here this is being used to define what all information will be taken from the patient.
...
{
    COORD pos = {x, y}; 
    //coord is a structure used to hold screen coordinates x and y.
...
{
    printf("\n");
    printf("\t\t\t\t\t\t CS-102 LAB PROJECT \n");
    printf("\n");
    printf("\t\t\t\t\t      HOSPITAL MANAGMENT SYSTEM \n");
    printf("\n");
    printf("\t\t\t\t\t\t Submitted by - GROUP 4\n");
    printf("\n");
    system("COLOR 5");
    title();
    regstr();
    ...
    // title function is used to display the name of the hospital on the main login page of the managment system.

void title()
{
    printf("\n\t\t\t\t\t---------------------------------------------------------\n");
    printf("\t\t\t\t\t              Welcome to Asian Fields Hospital              \n");
    printf("\t\t\t\t\t-------------------------------------------------------------\n");
}

    // inner_title function will display the name of the hospital in inner pages the managment system containing all the information
...
void inner_title()
{
    ...
    //Registration age will be used to get the login crednetials from the user  which will be used further to login.
void regstr()
{
    printf("PLEASE ENTER THE REGISTRATION DATA\n");
    printf("Enter your username : ");
    scanf("%s",uname);

    printf("enter your dob as password : ");
    scanf("%d",&dob);
    printf("\n");
}
...
void login()
{
    ...
    do
    {
     ...
     scanf("%d",&dateofbirth);
         ...
         if ((strcmp(username,uname)==0)&& (dateofbirth==dob))
     {
        printf("\n\t\t\tlogin sucessfull\n");
    ...
    //A total of 3 chances will be given to user to try to  login sucessfully into the page.
     else
        {
    ...
    //if the no. of trial chances increses to that allowed then the user will not be allowed to login and code will end.
